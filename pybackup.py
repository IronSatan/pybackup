...
#
# ToDo:
# 1. Add runtime flags (In Progress)
...
backup_command = "sudo rsync -av --human-readable --exclude-from=" + exclude_path + " /home/ '" + working_dir + "'"
...
print parser.parse_args() #print out the arguments from the argpars
